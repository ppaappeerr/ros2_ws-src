...
class Metaclass_WriteState_Event(type):
    """Metaclass of message 'WriteState_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__write_state__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__write_state__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__write_state__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__write_state__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__write_state__event
...
class WriteState_Event(metaclass=Metaclass_WriteState_Event):
    """Message class 'WriteState_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<cartographer_ros_msgs/WriteState_Request, 1>',
        'response': 'sequence<cartographer_ros_msgs/WriteState_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['cartographer_ros_msgs', 'srv'], 'WriteState_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['cartographer_ros_msgs', 'srv'], 'WriteState_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from cartographer_ros_msgs.srv import WriteState_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, WriteState_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'WriteState_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from cartographer_ros_msgs.srv import WriteState_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, WriteState_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'WriteState_Response'"
...
class Metaclass_WriteState(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _write_state.Metaclass_WriteState_Event._TYPE_SUPPORT is None:
                _write_state.Metaclass_WriteState_Event.__import_type_support__()
...
class WriteState(metaclass=Metaclass_WriteState):
    ...
    from cartographer_ros_msgs.srv._write_state import WriteState_Event as Event
