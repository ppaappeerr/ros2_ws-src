...
enum
{
  cartographer_ros_msgs__srv__ReadMetrics_Event__request__MAX_SIZE = 1
};
// response
enum
{
  cartographer_ros_msgs__srv__ReadMetrics_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/ReadMetrics in the package cartographer_ros_msgs.
typedef struct cartographer_ros_msgs__srv__ReadMetrics_Event
{
  service_msgs__msg__ServiceEventInfo info;
  cartographer_ros_msgs__srv__ReadMetrics_Request__Sequence request;
  cartographer_ros_msgs__srv__ReadMetrics_Response__Sequence response;
} cartographer_ros_msgs__srv__ReadMetrics_Event;

// Struct for a sequence of cartographer_ros_msgs__srv__ReadMetrics_Event.
typedef struct cartographer_ros_msgs__srv__ReadMetrics_Event__Sequence
{
