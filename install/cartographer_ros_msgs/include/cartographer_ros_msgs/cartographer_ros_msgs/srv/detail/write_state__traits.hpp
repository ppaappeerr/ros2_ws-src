...
inline std::string to_yaml(const WriteState_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use cartographer_ros_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const cartographer_ros_msgs::srv::WriteState_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  cartographer_ros_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use cartographer_ros_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const cartographer_ros_msgs::srv::WriteState_Event & msg)
{
  return cartographer_ros_msgs::srv::to_yaml(msg);
}

template<>
inline const char * data_type<cartographer_ros_msgs::srv::WriteState_Event>()
{
  return "cartographer_ros_msgs::srv::WriteState_Event";
}

template<>
inline const char * name<cartographer_ros_msgs::srv::WriteState_Event>()
{
  return "cartographer_ros_msgs/srv/WriteState_Event";
}

template<>
struct has_fixed_size<cartographer_ros_msgs::srv::WriteState_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<cartographer_ros_msgs::srv::WriteState_Event>
  : std::integral_constant<bool, has_bounded_size<cartographer_ros_msgs::srv::WriteState_Request>::value && has_bounded_size<cartographer_ros_msgs::srv::WriteState_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<cartographer_ros_msgs::srv::WriteState_Event>
  : std::true_type {};
