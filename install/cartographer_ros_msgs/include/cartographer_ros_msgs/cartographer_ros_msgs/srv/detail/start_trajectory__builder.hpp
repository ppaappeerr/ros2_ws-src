...
{
public:
  explicit Init_StartTrajectory_Event_response(::cartographer_ros_msgs::srv::StartTrajectory_Event & msg)
  : msg_(msg)
  {}
  ::cartographer_ros_msgs::srv::StartTrajectory_Event response(::cartographer_ros_msgs::srv::StartTrajectory_Event::_response_type arg)
  {
...
private:
  ::cartographer_ros_msgs::srv::StartTrajectory_Event msg_;
};

class Init_StartTrajectory_Event_request
{
public:
  explicit Init_StartTrajectory_Event_request(::cartographer_ros_msgs::srv::StartTrajectory_Event & msg)
  : msg_(msg)
  {}
  Init_StartTrajectory_Event_response request(::cartographer_ros_msgs::srv::StartTrajectory_Event::_request_type arg)
  {
...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_StartTrajectory_Event_request info(::cartographer_ros_msgs::srv::StartTrajectory_Event::_info_type arg)
  {
...
template<>
inline
auto build<::cartographer_ros_msgs::srv::StartTrajectory_Event>()
{
  return cartographer_ros_msgs::srv::builder::Init_StartTrajectory_Event_info();
}
