  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0x91, 0xcf, 0x75, 0xeb, 0xb6, 0xb5, 0x41, 0x9b,
      0x66, 0x92, 0x30, 0x85, 0x97, 0x01, 0x74, 0xaf,
      0x61, 0x22, 0xb7, 0x11, 0x36, 0xd9, 0xaa, 0xc7,
      0xd9, 0x8b, 0xff, 0xe3, 0xc2, 0xee, 0xd2, 0xbb,
    }};
  return &hash;
}
...
static const rosidl_type_hash_t cartographer_ros_msgs__msg__LandmarkEntry__EXPECTED_HASH = {1, {
...
static char cartographer_ros_msgs__msg__LandmarkList__TYPE_NAME[] = "cartographer_ros_msgs/msg/LandmarkList";
...
static char cartographer_ros_msgs__msg__LandmarkList__FIELD_NAME__header[] = "header";
static char cartographer_ros_msgs__msg__LandmarkList__FIELD_NAME__landmarks[] = "landmarks";

static rosidl_runtime_c__type_description__Field cartographer_ros_msgs__msg__LandmarkList__FIELDS[] = {
  {
    {cartographer_ros_msgs__msg__LandmarkList__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {cartographer_ros_msgs__msg__LandmarkList__FIELD_NAME__landmarks, 9, 9},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription cartographer_ros_msgs__msg__LandmarkList__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {cartographer_ros_msgs__msg__LandmarkList__TYPE_NAME, 38, 38},
      {cartographer_ros_msgs__msg__LandmarkList__FIELDS, 2, 2},
    },
    {cartographer_ros_msgs__msg__LandmarkList__REFERENCED_TYPE_DESCRIPTIONS, 6, 6},
  };
  if (!constructed) {
    assert(0 == memcmp(&builtin_interfaces__msg__Time__EXPECTED_HASH, builtin_interfaces__msg__Time__get_type_hash(NULL), sizeof(rosidl_type_hash_t)));
    description.referenced_type_descriptions.data[0].fields = builtin_interfaces__msg__Time__get_type_description(NULL)->type_description.fields;
    assert(0 == memcmp(&cartographer_ros_msgs__msg__LandmarkEntry__EXPECTED_HASH, cartographer_ros_msgs__msg__LandmarkEntry__get_type_hash(NULL), sizeof(rosidl_type_hash_t)));
    description.referenced_type_descriptions.data[1].fields = cartographer_ros_msgs__msg__LandmarkEntry__get_type_description(NULL)->type_description.fields;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *cartographer_ros_msgs__msg__LandmarkList__get_individual_type_description_source(NULL),
    sources[1] = *builtin_interfaces__msg__Time__get_individual_type_description_source(NULL);
    sources[2] = *cartographer_ros_msgs__msg__LandmarkEntry__get_individual_type_description_source(NULL);
