  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0x4c, 0xd4, 0x47, 0x0f, 0xaa, 0x35, 0x92, 0x20,
      0x92, 0x44, 0xe5, 0xfc, 0xb1, 0x49, 0x28, 0x79,
      0x38, 0x15, 0x63, 0x90, 0x2f, 0xa3, 0x6c, 0xd6,
      0x7c, 0x36, 0xe4, 0xb9, 0x43, 0xf2, 0x22, 0x2f,
    }};
  return &hash;
}
...
static const rosidl_type_hash_t cartographer_ros_msgs__msg__SubmapEntry__EXPECTED_HASH = {1, {
...
static char cartographer_ros_msgs__msg__SubmapList__TYPE_NAME[] = "cartographer_ros_msgs/msg/SubmapList";
...
static char cartographer_ros_msgs__msg__SubmapList__FIELD_NAME__header[] = "header";
static char cartographer_ros_msgs__msg__SubmapList__FIELD_NAME__submap[] = "submap";

static rosidl_runtime_c__type_description__Field cartographer_ros_msgs__msg__SubmapList__FIELDS[] = {
  {
    {cartographer_ros_msgs__msg__SubmapList__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {cartographer_ros_msgs__msg__SubmapList__FIELD_NAME__submap, 6, 6},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription cartographer_ros_msgs__msg__SubmapList__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {cartographer_ros_msgs__msg__SubmapList__TYPE_NAME, 36, 36},
      {cartographer_ros_msgs__msg__SubmapList__FIELDS, 2, 2},
    },
    {cartographer_ros_msgs__msg__SubmapList__REFERENCED_TYPE_DESCRIPTIONS, 6, 6},
  };
  if (!constructed) {
    assert(0 == memcmp(&builtin_interfaces__msg__Time__EXPECTED_HASH, builtin_interfaces__msg__Time__get_type_hash(NULL), sizeof(rosidl_type_hash_t)));
    description.referenced_type_descriptions.data[0].fields = builtin_interfaces__msg__Time__get_type_description(NULL)->type_description.fields;
    assert(0 == memcmp(&cartographer_ros_msgs__msg__SubmapEntry__EXPECTED_HASH, cartographer_ros_msgs__msg__SubmapEntry__get_type_hash(NULL), sizeof(rosidl_type_hash_t)));
    description.referenced_type_descriptions.data[1].fields = cartographer_ros_msgs__msg__SubmapEntry__get_type_description(NULL)->type_description.fields;
...
cartographer_ros_msgs__msg__SubmapList__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *cartographer_ros_msgs__msg__SubmapList__get_individual_type_description_source(NULL),
    sources[1] = *builtin_interfaces__msg__Time__get_individual_type_description_source(NULL);
    sources[2] = *cartographer_ros_msgs__msg__SubmapEntry__get_individual_type_description_source(NULL);
