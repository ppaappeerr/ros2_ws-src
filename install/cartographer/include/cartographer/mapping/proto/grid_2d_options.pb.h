...
enum GridOptions2D_GridType : int {
  ...
  GridOptions2D_GridType_GridOptions2D_GridType_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  GridOptions2D_GridType_GridOptions2D_GridType_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
...
class GridOptions2D final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR GridOptions2D(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  GridOptions2D* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const GridOptions2D& from) {
    GridOptions2D::MergeImpl(*this, from);
  }
  private:
...
inline ::cartographer::mapping::proto::GridOptions2D_GridType GridOptions2D::_internal_grid_type() const {
  return static_cast< ::cartographer::mapping::proto::GridOptions2D_GridType >(_impl_.grid_type_);
}
