...
class HybridGrid final :
 ...
 public:
  ...
  ~HybridGrid() override;
  explicit PROTOBUF_CONSTEXPR HybridGrid(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  HybridGrid* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const HybridGrid& from) {
    HybridGrid::MergeImpl(*this, from);
  }
  private:
  ...
  private:
  int32_t _internal_x_indices(int index) const;
  const ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >&
      _internal_x_indices() const;
  void _internal_add_x_indices(int32_t value);
  ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >*
      _internal_mutable_x_indices();
  public:
  int32_t x_indices(int index) const;
  void set_x_indices(int index, int32_t value);
  void add_x_indices(int32_t value);
  const ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >&
      x_indices() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >*
      mutable_x_indices();
  ...
  private:
  int32_t _internal_y_indices(int index) const;
  const ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >&
      _internal_y_indices() const;
  void _internal_add_y_indices(int32_t value);
  ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >*
      _internal_mutable_y_indices();
  public:
  int32_t y_indices(int index) const;
  void set_y_indices(int index, int32_t value);
  void add_y_indices(int32_t value);
  const ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >&
      y_indices() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >*
      mutable_y_indices();
  ...
  private:
  int32_t _internal_z_indices(int index) const;
  const ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >&
      _internal_z_indices() const;
  void _internal_add_z_indices(int32_t value);
  ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >*
      _internal_mutable_z_indices();
  public:
  int32_t z_indices(int index) const;
  void set_z_indices(int index, int32_t value);
  void add_z_indices(int32_t value);
  const ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >&
      z_indices() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >*
      mutable_z_indices();
 ...
 private:
  ...
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t > x_indices_;
    mutable std::atomic<int> _x_indices_cached_byte_size_;
    ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t > y_indices_;
    mutable std::atomic<int> _y_indices_cached_byte_size_;
    ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t > z_indices_;
...
inline int32_t HybridGrid::_internal_x_indices(int index) const {
  return _impl_.x_indices_.Get(index);
}
inline int32_t HybridGrid::x_indices(int index) const {
  // @@protoc_insertion_point(field_get:cartographer.mapping.proto.HybridGrid.x_indices)
  return _internal_x_indices(index);
}
inline void HybridGrid::set_x_indices(int index, int32_t value) {
  _impl_.x_indices_.Set(index, value);
  // @@protoc_insertion_point(field_set:cartographer.mapping.proto.HybridGrid.x_indices)
}
inline void HybridGrid::_internal_add_x_indices(int32_t value) {
  _impl_.x_indices_.Add(value);
}
inline void HybridGrid::add_x_indices(int32_t value) {
...
inline int32_t HybridGrid::_internal_y_indices(int index) const {
  return _impl_.y_indices_.Get(index);
}
inline int32_t HybridGrid::y_indices(int index) const {
  // @@protoc_insertion_point(field_get:cartographer.mapping.proto.HybridGrid.y_indices)
  return _internal_y_indices(index);
}
inline void HybridGrid::set_y_indices(int index, int32_t value) {
  _impl_.y_indices_.Set(index, value);
  // @@protoc_insertion_point(field_set:cartographer.mapping.proto.HybridGrid.y_indices)
}
inline void HybridGrid::_internal_add_y_indices(int32_t value) {
  _impl_.y_indices_.Add(value);
}
inline void HybridGrid::add_y_indices(int32_t value) {
...
inline int32_t HybridGrid::_internal_z_indices(int index) const {
  return _impl_.z_indices_.Get(index);
}
inline int32_t HybridGrid::z_indices(int index) const {
  // @@protoc_insertion_point(field_get:cartographer.mapping.proto.HybridGrid.z_indices)
  return _internal_z_indices(index);
}
inline void HybridGrid::set_z_indices(int index, int32_t value) {
  _impl_.z_indices_.Set(index, value);
  // @@protoc_insertion_point(field_set:cartographer.mapping.proto.HybridGrid.z_indices)
}
inline void HybridGrid::_internal_add_z_indices(int32_t value) {
  _impl_.z_indices_.Add(value);
}
inline void HybridGrid::add_z_indices(int32_t value) {
...
inline int32_t HybridGrid::_internal_values(int index) const {
  return _impl_.values_.Get(index);
}
inline int32_t HybridGrid::values(int index) const {
  // @@protoc_insertion_point(field_get:cartographer.mapping.proto.HybridGrid.values)
  return _internal_values(index);
}
inline void HybridGrid::set_values(int index, int32_t value) {
  _impl_.values_.Set(index, value);
  // @@protoc_insertion_point(field_set:cartographer.mapping.proto.HybridGrid.values)
}
inline void HybridGrid::_internal_add_values(int32_t value) {
  _impl_.values_.Add(value);
}
inline void HybridGrid::add_values(int32_t value) {
