...
class SaveMap_Event(metaclass=Metaclass_SaveMap_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<lio_sam/SaveMap_Request, 1>',
        'response': 'sequence<lio_sam/SaveMap_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['lio_sam', 'srv'], 'SaveMap_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['lio_sam', 'srv'], 'SaveMap_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from lio_sam.srv import SaveMap_Request
    ...
    def response(self, value):
        if self._check_fields:
            from lio_sam.srv import SaveMap_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class SaveMap(metaclass=Metaclass_SaveMap):
    ...
    from lio_sam.srv._save_map import SaveMap_Event as Event
