...
void cartographer_ros_msgs__srv__TrajectoryQuery_Event__rosidl_typesupport_introspection_c__TrajectoryQuery_Event_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  cartographer_ros_msgs__srv__TrajectoryQuery_Event__init(message_memory);
}

void cartographer_ros_msgs__srv__TrajectoryQuery_Event__rosidl_typesupport_introspection_c__TrajectoryQuery_Event_fini_function(void * message_memory)
{
  cartographer_ros_msgs__srv__TrajectoryQuery_Event__fini(message_memory);
}

size_t cartographer_ros_msgs__srv__TrajectoryQuery_Event__rosidl_typesupport_introspection_c__size_function__TrajectoryQuery_Event__request(
  const void * untyped_member)
{
  const cartographer_ros_msgs__srv__TrajectoryQuery_Request__Sequence * member =
    (const cartographer_ros_msgs__srv__TrajectoryQuery_Request__Sequence *)(untyped_member);
  return member->size;
}

const void * cartographer_ros_msgs__srv__TrajectoryQuery_Event__rosidl_typesupport_introspection_c__get_const_function__TrajectoryQuery_Event__request(
  const void * untyped_member, size_t index)
{
  const cartographer_ros_msgs__srv__TrajectoryQuery_Request__Sequence * member =
    (const cartographer_ros_msgs__srv__TrajectoryQuery_Request__Sequence *)(untyped_member);
...
void * cartographer_ros_msgs__srv__TrajectoryQuery_Event__rosidl_typesupport_introspection_c__get_function__TrajectoryQuery_Event__request(
  void * untyped_member, size_t index)
{
  cartographer_ros_msgs__srv__TrajectoryQuery_Request__Sequence * member =
    (cartographer_ros_msgs__srv__TrajectoryQuery_Request__Sequence *)(untyped_member);
  return &member->data[index];
}

void cartographer_ros_msgs__srv__TrajectoryQuery_Event__rosidl_typesupport_introspection_c__fetch_function__TrajectoryQuery_Event__request(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const cartographer_ros_msgs__srv__TrajectoryQuery_Request * item =
    ((const cartographer_ros_msgs__srv__TrajectoryQuery_Request *)
    cartographer_ros_msgs__srv__TrajectoryQuery_Event__rosidl_typesupport_introspection_c__get_const_function__TrajectoryQuery_Event__request(untyped_member, index));
  cartographer_ros_msgs__srv__TrajectoryQuery_Request * value =
    (cartographer_ros_msgs__srv__TrajectoryQuery_Request *)(untyped_value);
  *value = *item;
}

void cartographer_ros_msgs__srv__TrajectoryQuery_Event__rosidl_typesupport_introspection_c__assign_function__TrajectoryQuery_Event__request(
  void * untyped_member, size_t index, const void * untyped_value)
{
  cartographer_ros_msgs__srv__TrajectoryQuery_Request * item =
    ((cartographer_ros_msgs__srv__TrajectoryQuery_Request *)
    cartographer_ros_msgs__srv__TrajectoryQuery_Event__rosidl_typesupport_introspection_c__get_function__TrajectoryQuery_Event__request(untyped_member, index));
  const cartographer_ros_msgs__srv__TrajectoryQuery_Request * value =
    (const cartographer_ros_msgs__srv__TrajectoryQuery_Request *)(untyped_value);
  *item = *value;
}

bool cartographer_ros_msgs__srv__TrajectoryQuery_Event__rosidl_typesupport_introspection_c__resize_function__TrajectoryQuery_Event__request(
  void * untyped_member, size_t size)
{
  cartographer_ros_msgs__srv__TrajectoryQuery_Request__Sequence * member =
    (cartographer_ros_msgs__srv__TrajectoryQuery_Request__Sequence *)(untyped_member);
  cartographer_ros_msgs__srv__TrajectoryQuery_Request__Sequence__fini(member);
  return cartographer_ros_msgs__srv__TrajectoryQuery_Request__Sequence__init(member, size);
}

size_t cartographer_ros_msgs__srv__TrajectoryQuery_Event__rosidl_typesupport_introspection_c__size_function__TrajectoryQuery_Event__response(
  const void * untyped_member)
{
  const cartographer_ros_msgs__srv__TrajectoryQuery_Response__Sequence * member =
    (const cartographer_ros_msgs__srv__TrajectoryQuery_Response__Sequence *)(untyped_member);
  return member->size;
}

const void * cartographer_ros_msgs__srv__TrajectoryQuery_Event__rosidl_typesupport_introspection_c__get_const_function__TrajectoryQuery_Event__response(
  const void * untyped_member, size_t index)
{
  const cartographer_ros_msgs__srv__TrajectoryQuery_Response__Sequence * member =
    (const cartographer_ros_msgs__srv__TrajectoryQuery_Response__Sequence *)(untyped_member);
...
void * cartographer_ros_msgs__srv__TrajectoryQuery_Event__rosidl_typesupport_introspection_c__get_function__TrajectoryQuery_Event__response(
  void * untyped_member, size_t index)
{
  cartographer_ros_msgs__srv__TrajectoryQuery_Response__Sequence * member =
    (cartographer_ros_msgs__srv__TrajectoryQuery_Response__Sequence *)(untyped_member);
  return &member->data[index];
}

void cartographer_ros_msgs__srv__TrajectoryQuery_Event__rosidl_typesupport_introspection_c__fetch_function__TrajectoryQuery_Event__response(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const cartographer_ros_msgs__srv__TrajectoryQuery_Response * item =
    ((const cartographer_ros_msgs__srv__TrajectoryQuery_Response *)
    cartographer_ros_msgs__srv__TrajectoryQuery_Event__rosidl_typesupport_introspection_c__get_const_function__TrajectoryQuery_Event__response(untyped_member, index));
  cartographer_ros_msgs__srv__TrajectoryQuery_Response * value =
    (cartographer_ros_msgs__srv__TrajectoryQuery_Response *)(untyped_value);
  *value = *item;
}

void cartographer_ros_msgs__srv__TrajectoryQuery_Event__rosidl_typesupport_introspection_c__assign_function__TrajectoryQuery_Event__response(
  void * untyped_member, size_t index, const void * untyped_value)
{
  cartographer_ros_msgs__srv__TrajectoryQuery_Response * item =
    ((cartographer_ros_msgs__srv__TrajectoryQuery_Response *)
    cartographer_ros_msgs__srv__TrajectoryQuery_Event__rosidl_typesupport_introspection_c__get_function__TrajectoryQuery_Event__response(untyped_member, index));
  const cartographer_ros_msgs__srv__TrajectoryQuery_Response * value =
    (const cartographer_ros_msgs__srv__TrajectoryQuery_Response *)(untyped_value);
  *item = *value;
}

bool cartographer_ros_msgs__srv__TrajectoryQuery_Event__rosidl_typesupport_introspection_c__resize_function__TrajectoryQuery_Event__response(
  void * untyped_member, size_t size)
{
  cartographer_ros_msgs__srv__TrajectoryQuery_Response__Sequence * member =
    (cartographer_ros_msgs__srv__TrajectoryQuery_Response__Sequence *)(untyped_member);
  cartographer_ros_msgs__srv__TrajectoryQuery_Response__Sequence__fini(member);
  return cartographer_ros_msgs__srv__TrajectoryQuery_Response__Sequence__init(member, size);
}

static rosidl_typesupport_introspection_c__MessageMember cartographer_ros_msgs__srv__TrajectoryQuery_Event__rosidl_typesupport_introspection_c__TrajectoryQuery_Event_message_member_array[3] = {
  {
    "info",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(cartographer_ros_msgs__srv__TrajectoryQuery_Event, info),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    1,  // array size
    true,  // is upper bound
    offsetof(cartographer_ros_msgs__srv__TrajectoryQuery_Event, request),  // bytes offset in struct
    NULL,  // default value
    cartographer_ros_msgs__srv__TrajectoryQuery_Event__rosidl_typesupport_introspection_c__size_function__TrajectoryQuery_Event__request,  // size() function pointer
    cartographer_ros_msgs__srv__TrajectoryQuery_Event__rosidl_typesupport_introspection_c__get_const_function__TrajectoryQuery_Event__request,  // get_const(index) function pointer
    cartographer_ros_msgs__srv__TrajectoryQuery_Event__rosidl_typesupport_introspection_c__get_function__TrajectoryQuery_Event__request,  // get(index) function pointer
    cartographer_ros_msgs__srv__TrajectoryQuery_Event__rosidl_typesupport_introspection_c__fetch_function__TrajectoryQuery_Event__request,  // fetch(index, &value) function pointer
    cartographer_ros_msgs__srv__TrajectoryQuery_Event__rosidl_typesupport_introspection_c__assign_function__TrajectoryQuery_Event__request,  // assign(index, value) function pointer
    cartographer_ros_msgs__srv__TrajectoryQuery_Event__rosidl_typesupport_introspection_c__resize_function__TrajectoryQuery_Event__request  // resize(index) function pointer
  },
  {
    "response",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_MESSAGE,  // type
    ...
    1,  // array size
    true,  // is upper bound
    offsetof(cartographer_ros_msgs__srv__TrajectoryQuery_Event, response),  // bytes offset in struct
    NULL,  // default value
    cartographer_ros_msgs__srv__TrajectoryQuery_Event__rosidl_typesupport_introspection_c__size_function__TrajectoryQuery_Event__response,  // size() function pointer
    cartographer_ros_msgs__srv__TrajectoryQuery_Event__rosidl_typesupport_introspection_c__get_const_function__TrajectoryQuery_Event__response,  // get_const(index) function pointer
    cartographer_ros_msgs__srv__TrajectoryQuery_Event__rosidl_typesupport_introspection_c__get_function__TrajectoryQuery_Event__response,  // get(index) function pointer
    cartographer_ros_msgs__srv__TrajectoryQuery_Event__rosidl_typesupport_introspection_c__fetch_function__TrajectoryQuery_Event__response,  // fetch(index, &value) function pointer
    cartographer_ros_msgs__srv__TrajectoryQuery_Event__rosidl_typesupport_introspection_c__assign_function__TrajectoryQuery_Event__response,  // assign(index, value) function pointer
    cartographer_ros_msgs__srv__TrajectoryQuery_Event__rosidl_typesupport_introspection_c__resize_function__TrajectoryQuery_Event__response  // resize(index) function pointer
  }
};

static const rosidl_typesupport_introspection_c__MessageMembers cartographer_ros_msgs__srv__TrajectoryQuery_Event__rosidl_typesupport_introspection_c__TrajectoryQuery_Event_message_members = {
  "cartographer_ros_msgs__srv",  // message namespace
  "TrajectoryQuery_Event",  // message name
  3,  // number of fields
  sizeof(cartographer_ros_msgs__srv__TrajectoryQuery_Event),
  false,  // has_any_key_member_
  cartographer_ros_msgs__srv__TrajectoryQuery_Event__rosidl_typesupport_introspection_c__TrajectoryQuery_Event_message_member_array,  // message members
  cartographer_ros_msgs__srv__TrajectoryQuery_Event__rosidl_typesupport_introspection_c__TrajectoryQuery_Event_init_function,  // function to initialize message memory (memory has to be allocated)
  cartographer_ros_msgs__srv__TrajectoryQuery_Event__rosidl_typesupport_introspection_c__TrajectoryQuery_Event_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t cartographer_ros_msgs__srv__TrajectoryQuery_Event__rosidl_typesupport_introspection_c__TrajectoryQuery_Event_message_type_support_handle = {
  0,
  &cartographer_ros_msgs__srv__TrajectoryQuery_Event__rosidl_typesupport_introspection_c__TrajectoryQuery_Event_message_members,
  get_message_typesupport_handle_function,
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_cartographer_ros_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cartographer_ros_msgs, srv, TrajectoryQuery_Event)() {
  cartographer_ros_msgs__srv__TrajectoryQuery_Event__rosidl_typesupport_introspection_c__TrajectoryQuery_Event_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, service_msgs, msg, ServiceEventInfo)();
  cartographer_ros_msgs__srv__TrajectoryQuery_Event__rosidl_typesupport_introspection_c__TrajectoryQuery_Event_message_member_array[1].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cartographer_ros_msgs, srv, TrajectoryQuery_Request)();
  cartographer_ros_msgs__srv__TrajectoryQuery_Event__rosidl_typesupport_introspection_c__TrajectoryQuery_Event_message_member_array[2].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cartographer_ros_msgs, srv, TrajectoryQuery_Response)();
  if (!cartographer_ros_msgs__srv__TrajectoryQuery_Event__rosidl_typesupport_introspection_c__TrajectoryQuery_Event_message_type_support_handle.typesupport_identifier) {
    cartographer_ros_msgs__srv__TrajectoryQuery_Event__rosidl_typesupport_introspection_c__TrajectoryQuery_Event_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &cartographer_ros_msgs__srv__TrajectoryQuery_Event__rosidl_typesupport_introspection_c__TrajectoryQuery_Event_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
...
static rosidl_service_type_support_t cartographer_ros_msgs__srv__detail__trajectory_query__rosidl_typesupport_introspection_c__TrajectoryQuery_service_type_support_handle = {
  ...
  &cartographer_ros_msgs__srv__TrajectoryQuery_Request__rosidl_typesupport_introspection_c__TrajectoryQuery_Request_message_type_support_handle,
  &cartographer_ros_msgs__srv__TrajectoryQuery_Response__rosidl_typesupport_introspection_c__TrajectoryQuery_Response_message_type_support_handle,
  &cartographer_ros_msgs__srv__TrajectoryQuery_Event__rosidl_typesupport_introspection_c__TrajectoryQuery_Event_message_type_support_handle,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cartographer_ros_msgs, srv, TrajectoryQuery_Request)(void);

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cartographer_ros_msgs, srv, TrajectoryQuery_Response)(void);

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cartographer_ros_msgs, srv, TrajectoryQuery_Event)(void);

ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_cartographer_ros_msgs
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cartographer_ros_msgs, srv, TrajectoryQuery)(void) {
  ...
  if (!service_members->event_members_) {
    service_members->event_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cartographer_ros_msgs, srv, TrajectoryQuery_Event)()->data;
  }
