...
static const _FinishTrajectory_Event_type_support_symbol_names_t _FinishTrajectory_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cartographer_ros_msgs, srv, FinishTrajectory_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cartographer_ros_msgs, srv, FinishTrajectory_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, cartographer_ros_msgs, srv, FinishTrajectory_Event)() {
  return &::cartographer_ros_msgs::srv::rosidl_typesupport_c::FinishTrajectory_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t FinishTrajectory_service_type_support_handle = {
  ...
  &FinishTrajectory_Request_message_type_support_handle,
  &FinishTrajectory_Response_message_type_support_handle,
  &FinishTrajectory_Event_message_type_support_handle,
