  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: metrics
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_cartographer_ros_msgs__msg__Metric(
        &array_ptr[i], cdr);
    }
  }
  ...
  cartographer_ros_msgs__msg__MetricFamily * ros_message)
{
  ...
  // Field name: metrics
  {
    ...
    auto array_ptr = ros_message->metrics.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_cartographer_ros_msgs__msg__Metric(cdr, &array_ptr[i]);
    }
  }
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: metrics
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_cartographer_ros_msgs__msg__Metric(
        &array_ptr[i], cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: metrics
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_cartographer_ros_msgs__msg__Metric(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: metrics
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_cartographer_ros_msgs__msg__Metric(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const cartographer_ros_msgs__msg__MetricFamily * ros_message = static_cast<const cartographer_ros_msgs__msg__MetricFamily *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_cartographer_ros_msgs__msg__MetricFamily(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  cartographer_ros_msgs__msg__MetricFamily * ros_message = static_cast<cartographer_ros_msgs__msg__MetricFamily *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_cartographer_ros_msgs__msg__MetricFamily(cdr, ros_message);
}
