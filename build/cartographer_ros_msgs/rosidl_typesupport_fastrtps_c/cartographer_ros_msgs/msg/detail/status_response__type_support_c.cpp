  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const cartographer_ros_msgs__msg__StatusResponse * ros_message = static_cast<const cartographer_ros_msgs__msg__StatusResponse *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_cartographer_ros_msgs__msg__StatusResponse(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  cartographer_ros_msgs__msg__StatusResponse * ros_message = static_cast<cartographer_ros_msgs__msg__StatusResponse *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_cartographer_ros_msgs__msg__StatusResponse(cdr, ros_message);
}
