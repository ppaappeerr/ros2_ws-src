...
bool cdr_serialize_cartographer_ros_msgs__srv__SubmapQuery_Request(
  const cartographer_ros_msgs__srv__SubmapQuery_Request * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cartographer_ros_msgs
bool cdr_deserialize_cartographer_ros_msgs__srv__SubmapQuery_Request(
  eprosima::fastcdr::Cdr & cdr,
  cartographer_ros_msgs__srv__SubmapQuery_Request * ros_message)
{
  // Field name: trajectory_id
  {
    cdr >> ros_message->trajectory_id;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cartographer_ros_msgs
bool cdr_serialize_key_cartographer_ros_msgs__srv__SubmapQuery_Request(
  const cartographer_ros_msgs__srv__SubmapQuery_Request * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: trajectory_id
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cartographer_ros_msgs
size_t get_serialized_size_key_cartographer_ros_msgs__srv__SubmapQuery_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SubmapQuery_Request__ros_msg_type * ros_message = static_cast<const _SubmapQuery_Request__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cartographer_ros_msgs
size_t max_serialized_size_key_cartographer_ros_msgs__srv__SubmapQuery_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const cartographer_ros_msgs__srv__SubmapQuery_Request * ros_message = static_cast<const cartographer_ros_msgs__srv__SubmapQuery_Request *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_cartographer_ros_msgs__srv__SubmapQuery_Request(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  cartographer_ros_msgs__srv__SubmapQuery_Request * ros_message = static_cast<cartographer_ros_msgs__srv__SubmapQuery_Request *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_cartographer_ros_msgs__srv__SubmapQuery_Request(cdr, ros_message);
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cartographer_ros_msgs
bool cdr_serialize_cartographer_ros_msgs__srv__SubmapQuery_Response(
  const cartographer_ros_msgs__srv__SubmapQuery_Response * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: status
  {
  ...
  // Field name: textures
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_cartographer_ros_msgs__msg__SubmapTexture(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cartographer_ros_msgs
bool cdr_deserialize_cartographer_ros_msgs__srv__SubmapQuery_Response(
  eprosima::fastcdr::Cdr & cdr,
  cartographer_ros_msgs__srv__SubmapQuery_Response * ros_message)
{
  // Field name: status
  {
  ...
  // Field name: textures
  {
    ...
    auto array_ptr = ros_message->textures.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_cartographer_ros_msgs__msg__SubmapTexture(cdr, &array_ptr[i]);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cartographer_ros_msgs
bool cdr_serialize_key_cartographer_ros_msgs__srv__SubmapQuery_Response(
  const cartographer_ros_msgs__srv__SubmapQuery_Response * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: status
  ...
  // Field name: textures
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_cartographer_ros_msgs__msg__SubmapTexture(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cartographer_ros_msgs
size_t get_serialized_size_key_cartographer_ros_msgs__srv__SubmapQuery_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SubmapQuery_Response__ros_msg_type * ros_message = static_cast<const _SubmapQuery_Response__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: textures
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_cartographer_ros_msgs__msg__SubmapTexture(
        &array_ptr[index], current_alignment);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cartographer_ros_msgs
size_t max_serialized_size_key_cartographer_ros_msgs__srv__SubmapQuery_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: textures
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_cartographer_ros_msgs__msg__SubmapTexture(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const cartographer_ros_msgs__srv__SubmapQuery_Response * ros_message = static_cast<const cartographer_ros_msgs__srv__SubmapQuery_Response *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_cartographer_ros_msgs__srv__SubmapQuery_Response(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  cartographer_ros_msgs__srv__SubmapQuery_Response * ros_message = static_cast<cartographer_ros_msgs__srv__SubmapQuery_Response *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_cartographer_ros_msgs__srv__SubmapQuery_Response(cdr, ros_message);
}
...
using _SubmapQuery_Event__ros_msg_type = cartographer_ros_msgs__srv__SubmapQuery_Event;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cartographer_ros_msgs
bool cdr_serialize_cartographer_ros_msgs__srv__SubmapQuery_Event(
  const cartographer_ros_msgs__srv__SubmapQuery_Event * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: info
  {
  ...
  // Field name: request
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_cartographer_ros_msgs__srv__SubmapQuery_Request(
        &array_ptr[i], cdr);
    }
  }
  ...
  // Field name: response
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_cartographer_ros_msgs__srv__SubmapQuery_Response(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cartographer_ros_msgs
bool cdr_deserialize_cartographer_ros_msgs__srv__SubmapQuery_Event(
  eprosima::fastcdr::Cdr & cdr,
  cartographer_ros_msgs__srv__SubmapQuery_Event * ros_message)
{
  // Field name: info
  {
  ...
  // Field name: request
  {
    ...
    if (ros_message->request.data) {
      cartographer_ros_msgs__srv__SubmapQuery_Request__Sequence__fini(&ros_message->request);
    }
    if (!cartographer_ros_msgs__srv__SubmapQuery_Request__Sequence__init(&ros_message->request, size)) {
      fprintf(stderr, "failed to create array for field 'request'");
      return false;
    }
    auto array_ptr = ros_message->request.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_cartographer_ros_msgs__srv__SubmapQuery_Request(cdr, &array_ptr[i]);
    }
  }
  ...
  // Field name: response
  {
    ...
    if (ros_message->response.data) {
      cartographer_ros_msgs__srv__SubmapQuery_Response__Sequence__fini(&ros_message->response);
    }
    if (!cartographer_ros_msgs__srv__SubmapQuery_Response__Sequence__init(&ros_message->response, size)) {
      fprintf(stderr, "failed to create array for field 'response'");
      return false;
    }
    auto array_ptr = ros_message->response.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_cartographer_ros_msgs__srv__SubmapQuery_Response(cdr, &array_ptr[i]);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cartographer_ros_msgs
size_t get_serialized_size_cartographer_ros_msgs__srv__SubmapQuery_Event(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SubmapQuery_Event__ros_msg_type * ros_message = static_cast<const _SubmapQuery_Event__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  size_t initial_alignment = current_alignment;
  ...
  // Field name: request
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_cartographer_ros_msgs__srv__SubmapQuery_Request(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  // Field name: response
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_cartographer_ros_msgs__srv__SubmapQuery_Response(
        &array_ptr[index], current_alignment);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cartographer_ros_msgs
size_t max_serialized_size_cartographer_ros_msgs__srv__SubmapQuery_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_cartographer_ros_msgs__srv__SubmapQuery_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Field name: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_cartographer_ros_msgs__srv__SubmapQuery_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = cartographer_ros_msgs__srv__SubmapQuery_Event;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cartographer_ros_msgs
bool cdr_serialize_key_cartographer_ros_msgs__srv__SubmapQuery_Event(
  const cartographer_ros_msgs__srv__SubmapQuery_Event * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: info
  ...
  // Field name: request
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_cartographer_ros_msgs__srv__SubmapQuery_Request(
        &array_ptr[i], cdr);
    }
  }
  ...
  // Field name: response
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_cartographer_ros_msgs__srv__SubmapQuery_Response(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cartographer_ros_msgs
size_t get_serialized_size_key_cartographer_ros_msgs__srv__SubmapQuery_Event(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SubmapQuery_Event__ros_msg_type * ros_message = static_cast<const _SubmapQuery_Event__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: request
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_cartographer_ros_msgs__srv__SubmapQuery_Request(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  // Field name: response
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_cartographer_ros_msgs__srv__SubmapQuery_Response(
        &array_ptr[index], current_alignment);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cartographer_ros_msgs
size_t max_serialized_size_key_cartographer_ros_msgs__srv__SubmapQuery_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_cartographer_ros_msgs__srv__SubmapQuery_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Field name: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_cartographer_ros_msgs__srv__SubmapQuery_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
static bool _SubmapQuery_Event__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  if (!untyped_ros_message) {
  ...
  const cartographer_ros_msgs__srv__SubmapQuery_Event * ros_message = static_cast<const cartographer_ros_msgs__srv__SubmapQuery_Event *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_cartographer_ros_msgs__srv__SubmapQuery_Event(ros_message, cdr);
}

static bool _SubmapQuery_Event__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  if (!untyped_ros_message) {
  ...
  cartographer_ros_msgs__srv__SubmapQuery_Event * ros_message = static_cast<cartographer_ros_msgs__srv__SubmapQuery_Event *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_cartographer_ros_msgs__srv__SubmapQuery_Event(cdr, ros_message);
}

static uint32_t _SubmapQuery_Event__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_cartographer_ros_msgs__srv__SubmapQuery_Event(
      untyped_ros_message, 0));
}

static size_t _SubmapQuery_Event__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_cartographer_ros_msgs__srv__SubmapQuery_Event(
    full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t __callbacks_SubmapQuery_Event = {
  "cartographer_ros_msgs::srv",
  "SubmapQuery_Event",
  _SubmapQuery_Event__cdr_serialize,
  _SubmapQuery_Event__cdr_deserialize,
  _SubmapQuery_Event__get_serialized_size,
  _SubmapQuery_Event__max_serialized_size,
  nullptr
};

static rosidl_message_type_support_t _SubmapQuery_Event__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_SubmapQuery_Event,
  get_message_typesupport_handle_function,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cartographer_ros_msgs, srv, SubmapQuery_Event)() {
  return &_SubmapQuery_Event__type_support;
}
...
static rosidl_service_type_support_t SubmapQuery__handle = {
  ...
  &_SubmapQuery_Request__type_support,
  &_SubmapQuery_Response__type_support,
  &_SubmapQuery_Event__type_support,
