...
static const _StartTrajectory_Event_type_support_symbol_names_t _StartTrajectory_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cartographer_ros_msgs, srv, StartTrajectory_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cartographer_ros_msgs, srv, StartTrajectory_Event)),
  }
};
...
{
  return &::cartographer_ros_msgs::srv::rosidl_typesupport_cpp::StartTrajectory_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, cartographer_ros_msgs, srv, StartTrajectory_Event)() {
  return get_message_type_support_handle<cartographer_ros_msgs::srv::StartTrajectory_Event>();
}
...
static const rosidl_service_type_support_t StartTrajectory_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<cartographer_ros_msgs::srv::StartTrajectory_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<cartographer_ros_msgs::srv::StartTrajectory_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<cartographer_ros_msgs::srv::StartTrajectory_Event>(),
