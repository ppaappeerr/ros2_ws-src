...
class AdaptiveVoxelFilterOptions final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR AdaptiveVoxelFilterOptions(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  AdaptiveVoxelFilterOptions* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const AdaptiveVoxelFilterOptions& from) {
    AdaptiveVoxelFilterOptions::MergeImpl(*this, from);
  }
  private:
