...
class CeresSolverOptions final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR CeresSolverOptions(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  CeresSolverOptions* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const CeresSolverOptions& from) {
    CeresSolverOptions::MergeImpl(*this, from);
  }
  private:
...
inline void CeresSolverOptions::clear_use_nonmonotonic_steps() {
  _impl_.use_nonmonotonic_steps_ = false;
}
inline bool CeresSolverOptions::_internal_use_nonmonotonic_steps() const {
  return _impl_.use_nonmonotonic_steps_;
}
...
inline void CeresSolverOptions::_internal_set_use_nonmonotonic_steps(bool value) {
  ...
  _impl_.use_nonmonotonic_steps_ = value;
}
...
inline void CeresSolverOptions::clear_max_num_iterations() {
  _impl_.max_num_iterations_ = 0;
}
inline int32_t CeresSolverOptions::_internal_max_num_iterations() const {
  return _impl_.max_num_iterations_;
}
inline int32_t CeresSolverOptions::max_num_iterations() const {
...
inline void CeresSolverOptions::_internal_set_max_num_iterations(int32_t value) {
  
  _impl_.max_num_iterations_ = value;
}
inline void CeresSolverOptions::set_max_num_iterations(int32_t value) {
...
inline int32_t CeresSolverOptions::_internal_num_threads() const {
  return _impl_.num_threads_;
}
inline int32_t CeresSolverOptions::num_threads() const {
  // @@protoc_insertion_point(field_get:cartographer.common.proto.CeresSolverOptions.num_threads)
  return _internal_num_threads();
}
inline void CeresSolverOptions::_internal_set_num_threads(int32_t value) {
  
  _impl_.num_threads_ = value;
}
inline void CeresSolverOptions::set_num_threads(int32_t value) {
