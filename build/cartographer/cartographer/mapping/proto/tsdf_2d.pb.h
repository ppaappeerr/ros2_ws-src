...
class TSDF2D final :
 ...
 public:
  ...
  ~TSDF2D() override;
  explicit PROTOBUF_CONSTEXPR TSDF2D(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  TSDF2D* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  private:
  int32_t _internal_weight_cells(int index) const;
  const ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >&
      _internal_weight_cells() const;
  void _internal_add_weight_cells(int32_t value);
  ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >*
      _internal_mutable_weight_cells();
  public:
  int32_t weight_cells(int index) const;
  void set_weight_cells(int index, int32_t value);
  void add_weight_cells(int32_t value);
  const ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >&
      weight_cells() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >*
 ...
 private:
  ...
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t > weight_cells_;
...
inline int TSDF2D::_internal_weight_cells_size() const {
  return _impl_.weight_cells_.size();
}
...
inline int32_t TSDF2D::_internal_weight_cells(int index) const {
  return _impl_.weight_cells_.Get(index);
}
inline int32_t TSDF2D::weight_cells(int index) const {
  // @@protoc_insertion_point(field_get:cartographer.mapping.proto.TSDF2D.weight_cells)
  return _internal_weight_cells(index);
}
inline void TSDF2D::set_weight_cells(int index, int32_t value) {
  _impl_.weight_cells_.Set(index, value);
  // @@protoc_insertion_point(field_set:cartographer.mapping.proto.TSDF2D.weight_cells)
}
inline void TSDF2D::_internal_add_weight_cells(int32_t value) {
  _impl_.weight_cells_.Add(value);
}
inline void TSDF2D::add_weight_cells(int32_t value) {
