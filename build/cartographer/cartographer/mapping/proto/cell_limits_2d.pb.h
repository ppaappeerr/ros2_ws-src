...
class CellLimits final :
 ...
 public:
  ...
  ~CellLimits() override;
  explicit PROTOBUF_CONSTEXPR CellLimits(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  CellLimits* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const CellLimits& from) {
    CellLimits::MergeImpl(*this, from);
  }
  private:
  ...
  int32_t num_x_cells() const;
  void set_num_x_cells(int32_t value);
  private:
  int32_t _internal_num_x_cells() const;
  void _internal_set_num_x_cells(int32_t value);
  public:

  // int32 num_y_cells = 2;
  void clear_num_y_cells();
  int32_t num_y_cells() const;
  void set_num_y_cells(int32_t value);
  private:
  int32_t _internal_num_y_cells() const;
  void _internal_set_num_y_cells(int32_t value);
  public:
 ...
 private:
  ...
  struct Impl_ {
    int32_t num_x_cells_;
    int32_t num_y_cells_;
...
inline void CellLimits::clear_num_x_cells() {
  _impl_.num_x_cells_ = 0;
}
inline int32_t CellLimits::_internal_num_x_cells() const {
  return _impl_.num_x_cells_;
}
inline int32_t CellLimits::num_x_cells() const {
  // @@protoc_insertion_point(field_get:cartographer.mapping.proto.CellLimits.num_x_cells)
  return _internal_num_x_cells();
}
inline void CellLimits::_internal_set_num_x_cells(int32_t value) {
  
  _impl_.num_x_cells_ = value;
}
inline void CellLimits::set_num_x_cells(int32_t value) {
...
inline void CellLimits::clear_num_y_cells() {
  _impl_.num_y_cells_ = 0;
}
inline int32_t CellLimits::_internal_num_y_cells() const {
  return _impl_.num_y_cells_;
}
inline int32_t CellLimits::num_y_cells() const {
  // @@protoc_insertion_point(field_get:cartographer.mapping.proto.CellLimits.num_y_cells)
  return _internal_num_y_cells();
}
inline void CellLimits::_internal_set_num_y_cells(int32_t value) {
  
  _impl_.num_y_cells_ = value;
}
inline void CellLimits::set_num_y_cells(int32_t value) {
