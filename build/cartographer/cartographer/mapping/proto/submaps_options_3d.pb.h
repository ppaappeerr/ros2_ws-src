...
class SubmapsOptions3D final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR SubmapsOptions3D(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  SubmapsOptions3D* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const SubmapsOptions3D& from) {
    SubmapsOptions3D::MergeImpl(*this, from);
  }
  private:
  ...
  PROTOBUF_NODISCARD ::cartographer::mapping::proto::RangeDataInserterOptions3D* release_range_data_inserter_options();
...
inline void SubmapsOptions3D::clear_high_resolution_max_range() {
  _impl_.high_resolution_max_range_ = 0;
}
inline double SubmapsOptions3D::_internal_high_resolution_max_range() const {
  return _impl_.high_resolution_max_range_;
}
...
inline void SubmapsOptions3D::_internal_set_high_resolution_max_range(double value) {
  ...
  _impl_.high_resolution_max_range_ = value;
}
...
inline int32_t SubmapsOptions3D::_internal_num_range_data() const {
  return _impl_.num_range_data_;
}
inline int32_t SubmapsOptions3D::num_range_data() const {
...
inline void SubmapsOptions3D::_internal_set_num_range_data(int32_t value) {
  
  _impl_.num_range_data_ = value;
}
inline void SubmapsOptions3D::set_num_range_data(int32_t value) {
...
inline const ::cartographer::mapping::proto::RangeDataInserterOptions3D& SubmapsOptions3D::_internal_range_data_inserter_options() const {
  const ::cartographer::mapping::proto::RangeDataInserterOptions3D* p = _impl_.range_data_inserter_options_;
...
inline ::cartographer::mapping::proto::RangeDataInserterOptions3D* SubmapsOptions3D::release_range_data_inserter_options() {
  ...
  ::cartographer::mapping::proto::RangeDataInserterOptions3D* temp = _impl_.range_data_inserter_options_;
