...
class RealTimeCorrelativeScanMatcherOptions final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR RealTimeCorrelativeScanMatcherOptions(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  RealTimeCorrelativeScanMatcherOptions* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const RealTimeCorrelativeScanMatcherOptions& from) {
    RealTimeCorrelativeScanMatcherOptions::MergeImpl(*this, from);
  }
  private:
...
inline void RealTimeCorrelativeScanMatcherOptions::_internal_set_translation_delta_cost_weight(double value) {
  ...
  _impl_.translation_delta_cost_weight_ = value;
}
...
inline void RealTimeCorrelativeScanMatcherOptions::_internal_set_rotation_delta_cost_weight(double value) {
  ...
  _impl_.rotation_delta_cost_weight_ = value;
}
