...
class FastCorrelativeScanMatcherOptions2D final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR FastCorrelativeScanMatcherOptions2D(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  FastCorrelativeScanMatcherOptions2D* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const FastCorrelativeScanMatcherOptions2D& from) {
    FastCorrelativeScanMatcherOptions2D::MergeImpl(*this, from);
  }
  private:
...
inline void FastCorrelativeScanMatcherOptions2D::_internal_set_linear_search_window(double value) {
  ...
  _impl_.linear_search_window_ = value;
}
...
inline int32_t FastCorrelativeScanMatcherOptions2D::_internal_branch_and_bound_depth() const {
  return _impl_.branch_and_bound_depth_;
}
inline int32_t FastCorrelativeScanMatcherOptions2D::branch_and_bound_depth() const {
...
inline void FastCorrelativeScanMatcherOptions2D::_internal_set_branch_and_bound_depth(int32_t value) {
  
  _impl_.branch_and_bound_depth_ = value;
}
inline void FastCorrelativeScanMatcherOptions2D::set_branch_and_bound_depth(int32_t value) {
