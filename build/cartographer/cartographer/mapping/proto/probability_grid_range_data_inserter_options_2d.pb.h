...
class ProbabilityGridRangeDataInserterOptions2D final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR ProbabilityGridRangeDataInserterOptions2D(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  ProbabilityGridRangeDataInserterOptions2D* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const ProbabilityGridRangeDataInserterOptions2D& from) {
    ProbabilityGridRangeDataInserterOptions2D::MergeImpl(*this, from);
  }
  private:
...
inline void ProbabilityGridRangeDataInserterOptions2D::_internal_set_insert_free_space(bool value) {
  ...
  _impl_.insert_free_space_ = value;
}
