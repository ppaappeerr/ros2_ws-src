...
#include "cpp_package/msg/detail/nav_hint__rosidl_typesupport_fastrtps_c.h"
...
using _NavHint__ros_msg_type = cpp_package__msg__NavHint;
...
size_t get_serialized_size_cpp_package__msg__NavHint(
  ...
  size_t current_alignment)
{
  const _NavHint__ros_msg_type * ros_message = static_cast<const _NavHint__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cpp_package__msg__NavHint;
    is_plain =
      (
...
static bool _NavHint__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const cpp_package__msg__NavHint * ros_message = static_cast<const cpp_package__msg__NavHint *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_cpp_package__msg__NavHint(ros_message, cdr);
}

static bool _NavHint__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  cpp_package__msg__NavHint * ros_message = static_cast<cpp_package__msg__NavHint *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_cpp_package__msg__NavHint(cdr, ros_message);
}

static uint32_t _NavHint__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_cpp_package__msg__NavHint(
      untyped_ros_message, 0));
}

static size_t _NavHint__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_cpp_package__msg__NavHint(
...
static message_type_support_callbacks_t __callbacks_NavHint = {
  "cpp_package::msg",
  "NavHint",
  _NavHint__cdr_serialize,
  _NavHint__cdr_deserialize,
  _NavHint__get_serialized_size,
  _NavHint__max_serialized_size,
  nullptr
};

static rosidl_message_type_support_t _NavHint__type_support = {
