...
static const _NavHint_type_support_symbol_names_t _NavHint_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cpp_package, msg, NavHint)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cpp_package, msg, NavHint)),
  }
};
...
{
  return &::cpp_package::msg::rosidl_typesupport_cpp::NavHint_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, cpp_package, msg, NavHint)() {
  return get_message_type_support_handle<cpp_package::msg::NavHint>();
}
