...
#define NODE_MAIN_LOGGER_NAME "spark_lio_mapping"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libspark_lio_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<spark_fast_lio::SPARKFastLIO2>";
