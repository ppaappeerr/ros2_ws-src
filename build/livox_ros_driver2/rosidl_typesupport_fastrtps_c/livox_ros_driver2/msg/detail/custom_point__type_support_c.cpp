  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const livox_ros_driver2__msg__CustomPoint * ros_message = static_cast<const livox_ros_driver2__msg__CustomPoint *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_livox_ros_driver2__msg__CustomPoint(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  livox_ros_driver2__msg__CustomPoint * ros_message = static_cast<livox_ros_driver2__msg__CustomPoint *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_livox_ros_driver2__msg__CustomPoint(cdr, ros_message);
}
